...
import MyFile from "../1-hello-world/MyFile";
			...
			<SafeAreaView id="comp3" style={styles.container}>
				<View id="comp4" style={styles.content}>
					...
					{showQrCode == true ? (
						...
						>
							<Text id="comp10" style={styles.linkText}>
				...
				<View id="comp19" style={styles.centeredView}>
					<Modal
						id="comp13"
						animationType="slide"
						transparent={true}
					...
					>
						<View
							id="comp14"
							style={[styles.centeredView, styles.osid]}
						>
							<View id="comp15" style={styles.modalView}>
								<Text id="comp16" style={styles.modalText}>
									Hello User!
								</Text>
								<Pressable
									id="comp17"
								...
								>
									<Text id="comp18" style={styles.textStyle}>
										Hide
									</Text>
								</Pressable>
							</View>
					...
					>
						<Text id="comp20" style={styles.textStyle}>
